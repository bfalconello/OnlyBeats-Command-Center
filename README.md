...
4. Open **Live Games** and select **Refresh now**.
...
## Roadmap
The next feature release is **v0.3.0 — Saturday Wall**, followed by Team Hub, rankings, weather/game intel, news/reports, and the first stable v1.0 release.
